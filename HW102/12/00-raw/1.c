...
void check_and_del_budget(Movie_Budget ** temp_list_bdg,Movie_Budget * input_bdg);
void check_and_del_name(Movie_Name ** temp_list_nm,Movie_Name *input_name);
...
int fill_list(Movie_Budget **list_bdg,Movie_Name **list_nm,char* file){
    ...
    for(;;){
        ...
        check_and_del_budget(list_bdg,input_bdg);
        check_and_del_name(list_nm,input_name);
...
void check_and_del_budget(Movie_Budget ** temp_list_bdg,Movie_Budget * input_bdg){
    ...
    if(!strcmp(a->name,input_bdg->name)){
        
        *temp_list_bdg = a->next;
        free(a);
        return;
    }
    ...
    while(b!=NULL){
        ...
        if(!strcmp(b->name,input_bdg->name)){
            a->next = b->next;
            free(b);
...
void check_and_del_name(Movie_Name ** temp_list_nm,Movie_Name *input_name){
    ...
    if(!strcmp(b->name,input_name->name)){
        *temp_list_nm = b->next;
        free(b);
        return;
    }
